...
public class FrontEnd_TC_03_TVMenu extends AbstractTest {
	...
	public void TVMenu_01_VerifyCanShareWishlistToOtherPeopleUsingEmail() {
		...
		loginPage.clickToDynamicElement(driver, HomePageUI.HEADER_MENU, "TV");
		...
		tvPage.clickToDynamicElement(driver, AbstractPageUI_LiveGuru.DYNAMIC_BUTTON, "Share Wishlist");
	...
	public void TVMenu_02_VerifyCanAddReview() {
		...
		tvPage.clickToDynamicElement(driver, HomePageUI.HEADER_MENU, "TV");
		//tvPage = PageFactoryManager_LiveGuru.getTVPage(driver);
		...
		tvPage.clickToDynamicElement(driver, AbstractPageUI_LiveGuru.DYNAMIC_BUTTON, "Submit Review");
