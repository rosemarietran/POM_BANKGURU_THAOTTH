...
public class FrontEnd_TC_02_MobileMenu extends AbstractTest {
	...
	public void MobileMenu_02_VerifyDiscountCoupon() {
		...
		mobilePage.clickToDynamicElement(driver, HomePageUI.HEADER_MENU, "Mobile");
		...
		verifyTrue(mobilePage.isDynamicDisplayed(driver, AbstractPageUI_LiveGuru.DYNAMIC_MESSAGE,
		...
		verifyTrue(mobilePage.isDynamicDisplayed(driver, AbstractPageUI_LiveGuru.DYNAMIC_MESSAGE,
				"Coupon code \"GURU50\" was applied."));
	...
	public void MobileMenu_03_VerifyCantAddMore500ItemsOfProduct() {
		...
		mobilePage.inputToDynamicTextboxOrTextArea(driver, AbstractPageUI_LiveGuru.DYNAMIC_TEXTBOX_TEXTAREA, "Qty",
				"501");
		...
		log.info(
				"MobileMenu_03 - Step 05: Verify error message 'The maximum quantity allowed for purchase is 500.' is displayed");
		verifyEquals(mobilePage.getTextInElement(driver, MobilePageUI.CART_ERROR_MESSAGE),
		...
		log.info(
				"MobileMenu_03 - Step 07: Verify message 'Shopping Cart is Empty' and 'You have no items in your shopping cart.' are displayed");
		verifyTrue(mobilePage.isDynamicDisplayed(driver, AbstractPageUI_LiveGuru.DYNAMIC_PAGE_TITLE,
				"Shopping Cart is Empty"));
		verifyTrue(mobilePage.isDynamicDisplayed(driver, MobilePageUI.CART_EMPTY_MESSAGE_TEXT,
	...
	public void MobileMenu_04_VeriyCompareTwoProducts() {
		...
		log.info(
				"MobileMenu_04 - Step 08: Verify Comparison pop up is opened and 2 selected mobiles: IPhone and Sony Xperia are displayed in Comparison pop up");
		verifyEquals(mobilePage.getTextInElement(driver, MobilePageUI.COMPARE_PRODUCT_TITLE_IN_POP_UP),
				"COMPARE PRODUCTS");
